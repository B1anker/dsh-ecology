...
/**
 * Identifier → entry. An entry is either a ready instance or a
 * {@link SyncDescriptor} the container constructs on first use and then
 * replaces with the resulting singleton.
 *
