 ...
 */
export function requireVerifier(stored, envName) {
 ...
 * caller must not be able to choose how much CPU a single request costs.
 *
 ...
 */
export function verifyPassword(candidate, verifier) {
